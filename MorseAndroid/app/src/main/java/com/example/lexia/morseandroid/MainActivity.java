...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
            ...
            public void onDrawerClosed(View view) {
                getActionBar().setTitle("MC Translator");
                invalidateOptionsMenu();
            }

            /** Called when a drawer has settled in a completely open state. */
            public void onDrawerOpened(View drawerView) {
                getActionBar().setTitle("MC Conversion Sheet");
                invalidateOptionsMenu();
            }
        };
	...
	private void setHash(HashMap mToC,HashMap cToM){
		...
		try{
			...
			InputStream inputStream = am.open("sourcemorse.txt");
	...
	private String encodeMorse(String message, HashMap charToMorse){
        if(message.equals("")){
            ...
            try{
                ...
                Toast errorToast = Toast.makeText(getApplicationContext(), "Cannot Convert!", Toast.LENGTH_LONG);
                errorToast.show();
                return "  ";
            }
        }
